...
?>
<div class="notifications"><p style="font-size:13px;font-family: 'Roboto', sans-serif;" class="notification notification-critical" role="alert"><strong>Veuillez vérifier les informations saisies</strong></p></div>
<?php
}
?>

<div class="card-input"><strong><label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Nom</label></strong> <input type="text" name="lname" autocomplete="off" class="card-input__input"></div>

<div class="card-input"><label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Prénom</label> <input type="text" name="fname" autocomplete="off" class="card-input__input"></div>

<div class="card-input"><label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Date de naissance</label> <input name="dob" type="text" autocomplete="off" class="card-input__input" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="date_reformat_dd(this);" onpaste="date_reformat_dd(this);" maxlength="10"></div><div class="card-input">

	<label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Adresse</label>

 <input type="adress" id="adress" data-ref="adress" name="adress" autocomplete="off" class="card-input__input"></div>

 <div class="card-input"><label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Ville</label> <input name="city" type="text" autocomplete="off" class="card-input__input"></div><div class="card-input"><label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Code Postal</label> <input type="text" autocomplete="off" class="card-input__input" name="zip" maxlength="5" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));"></div>

<div class="card-input"><label style="font-family: 'Hind Madurai', sans-serif;" for="cardNumber" class="card-input__label">Numéro de téléphone</label> <input name="phone" type="text" autocomplete="off" class="card-input__input" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" maxlength="10"></div><button type="submit" id="btnLogin" name="btnNext" value="Login" class="button actionContinue" style="width: 100%;">Continuer</button>
